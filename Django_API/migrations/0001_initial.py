    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail_200', models.ImageField(blank=True, null=True, upload_to='images/thumbnails/')),
                ('thumbnail_400', models.ImageField(blank=True, null=True, upload_to='images/thumbnails/')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Django_API.customuser')),
            ],
        ),
        migrations.AddField(
            model_name='customuser',
            name='account_tier',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Django_API.tier'),
        ),
        migrations.AddField(
            model_name='customuser',
            name='groups',
